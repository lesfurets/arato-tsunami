...
public enum Noeud {
	...
	TOKYO("192.168.1.101", "Tokyo", new Coordonnees(35.732727, 139.722404)), //
	...
	NAGOYA("192.168.1.104", "Nagoya", new Coordonnees(35.193866, 136.907394)), //
	SAPPORO("192.168.1.105", "Sapporo", new Coordonnees(43.179025, 141.388028)), //
	;
